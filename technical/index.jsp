<%-- 
    Document   : index
    Created on : Jul 13, 2021, 7:48:23 PM
    Author     : USER
--%>
                ...
                <section class="container-fluid mt-0">
                    <section class="row justify-content-center mt-0">
                        <section class="col-12 col-sm-6 col-md-3 mt-0">
                            <form class="pt-1 bg-dark" style="width: 100%;position: absolute;top: 3vh;padding: 20px;border-radius: 10px;" action="${pageContext.request.contextPath}/technical" method="post">
                                ...
                                <div class="row mx-auto w-100 text-center text-white">
                                    ...
                                    <div class="col-3">
                                        <input type="radio" name="td" value="75">
                                        <span class="checkmark"></span>
                                    </div>
                                    <div class="col-2">
                                        <input type="radio" name="td" value="50" checked>
                                        <span class="checkmark"></span>
                                    </div>
                                    <div class="col-3">
                                        <input type="radio" name="td" value="25">
                                        <span class="checkmark"></span>
                                    </div>
                                </div>
                                <div class="row mb-0">
