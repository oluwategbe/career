<%-- 
    Document   : index
    Created on : Jun 20, 2021, 2:07:52 AM
    Author     : USER
--%>
                ...
                <section class="container-fluid">
                    <section class="row justify-content-center">
                        <section class="col-12 col-sm-6 col-md-3">
                            <form class="pt-1 bg-dark" style="width: 100%;position: absolute;top: 3vh;padding: 20px;border-radius: 10px;" action="${pageContext.request.contextPath}/commercial" method="post">
                                ...
                                <div class="row mx-auto w-100 text-center text-white">
                                    ...
                                    <div class="col-3">
                                        <input type="radio" name="marketing" value="75">
                                        <span class="checkmark"></span>
                                    </div>
                                    <div class="col-2">
                                        <input type="radio" name="marketing" value="50" checked>
                                        <span class="checkmark"></span>
                                    </div>
                                    <div class="col-3">
                                        <input type="radio" name="marketing" value="25">
                                        <span class="checkmark"></span>
                                    </div>
                                </div>
                                <div class="row mx-auto w-100 text-center text-white">
                                    <div class="col-4 text-center">
                                        <h5 class='h5'>Commerce</h5>
                                    </div>
                                    <div class="col-3">
                                        <input type="radio" name="commerce" value="75">
                                        <span class="checkmark"></span>
                                    </div>
                                    <div class="col-2">
                                        <input type="radio" name="commerce" value="50" checked>
                                        <span class="checkmark"></span>
                                    </div>
                                    <div class="col-3">
                                        <input type="radio" name="commerce" value="25">
                                        <span class="checkmark"></span>
                                    </div>
                                </div>
                                <div class="row mx-auto w-100 text-center text-white">
