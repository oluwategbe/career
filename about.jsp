<%-- 
    Document   : about
    Created on : Jul 8, 2021, 1:13:23 PM
    Author     : USER
--%>
        ...
        <div class="d-flex justify-content-center align-items-center bg-image" style="background-image: url('images/index.jpg');height: 100vh;">
            <div class="mask" style="background-color: rgba(0, 0, 0, 0.6)">
              ...
              <div class="p-5 text-center bg-danger">
                <h1 class="mb-3 h1 text-dark">About this Web Application</h1>
              </div>
              <div class="p-5 text-center bg-secondary" style="margin: 5vh; border-radius: 10px; border: 5px solid pink;">
                <h4 class="h4 text-white">This Web Application was made to suggest a possible career path for you based on your personality. 
                    Its questions are based on the Myers Briggs Type Indicator personality test which groups you into 1 of 16 personality types. 
                    The application then suggests a major which you can study in the university which fits your personality.
                </h4>
              </div>
          </div>
        </div>
